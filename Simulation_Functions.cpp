...
void pcg_solver(double* lhs, double* rhs, double* solutions, int dimen, int* solvediter)
{
    ...
    for(int i = 0; i < dimen; i++){solutions[i] = 0;}                                       /* set solutions to zero */
    #pragma omp parallel for
    for(int i = 0; i < dimen; i++){Minv[(i*dimen)+i] = 1 / lhs[(i*dimen)+i];}                /* inverse of diagonals is just 1 / diagonal of LHS */
    ...
    int incx = 1;
    int incy = 1;
    /* get e which is RHS  - (LHS * solutions); solutions was initialized to 0 so it is just RHS */
    ...
    while(diff > tol)
    {
        ...
        double intermediate = cblas_ddot(lhssize,p,incx,v,incy);
        alpha[0] = tau1[0] / intermediate;
    ...
    solvediter[0] = k;
    delete[] Minv; delete[] e; delete[] d; delete[] v; delete[] p;
    delete[] oldb; delete[] tau1; delete[] tau2; delete[] alpha; delete[] beta;
}
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
/////////////////////////     FUNCTION 10       /////////////////////////
