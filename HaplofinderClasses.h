...
private:
    ...
    int Length_R;                   /* Length of haplotype */
...
public:
    Unfavorable_Regions();
    Unfavorable_Regions(int chr = 0, int st_pos = 0,int en_pos = 0, int st_ind = 0, int en_ind = 0, std::string hap = "", int length = 0, double pheno = 0.0, double eff = 0.0, double lsm = 0.0, double tval = 0.0);
    ~Unfavorable_Regions();
    ...
    int getLength_R(){return Length_R;}
    ...
    friend bool sortByLength(const Unfavorable_Regions&, const Unfavorable_Regions&);
};
